...
public class ExplicitVisitorCreator extends BaseCompiler {
	public void compile(Resource genMM, ExplicitVisitorOptions options) throws IOException {
		...
		invokeTemplate("explicit_visitor.mustache", scopes, createClassFile(managerFile));

	}

	public static class VisitorWrapper extends ManagerBase {
		private ExplicitVisitorOptions options;
		private List<? extends EClassVisitor> baseEClasses;

		public VisitorWrapper(ExplicitVisitorOptions options2) {
	...
	public static class EClassVisitor extends EClassBase {
		...
		public EClassVisitor(GenClass genClass2, ManagerBase manager, ExplicitVisitorOptions options) {
